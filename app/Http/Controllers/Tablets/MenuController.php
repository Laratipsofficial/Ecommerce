...
class MenuController extends Controller
{
    ...
    {
        if(!$this->currentTableService->get()) {
        ...
        return Inertia::render('Tablets/Menus/Index', [
            'title' => 'MenuItems - ' . $table->number . ' - Round ' . $round,
    ...
    public function show(MenuItem $menuItem)
    {
        ...
        return Inertia::render('Tablets/Menus/Show', [
    ...
    public function update(TabletMenuRequest $request, MenuItem $menuItem)
    {
        ...
        return redirect()->route("tablets.{$this->routeResourceName}.index")->with('success', 'MenuItem created successfully.');
    }
}
