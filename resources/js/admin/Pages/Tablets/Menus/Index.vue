    ...
    <BreezeAuthenticatedLayout>
        ...
        <Container>
            <AddNew :show="isFilled">
                <Button
                        :href="route(`tablets.cart.index`)">Cart</Button>

                <Button
                    :href="route(`tablets.cart.create`)">checkout</Button>
            ...
            <Card class="mt-4"
                ...
                <Table :headers="headers"
                    ...
                    <template v-slot="{ item }">
                        ...
                        <Td>
                            <Actions :edit-link="route(`tablets.${routeResourceName}.show`, {id: item.id})"
                                     :show-edit="can.edit"
                                     :show-delete="false" />
                        </Td>
                    </template>
